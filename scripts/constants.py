...
D1_NEGATIVE_LOWERING_COEFFICIENT = 0.5  # A.3.6
...
REGULAR_TOURNAMENT_COEFFICIENT = 1
STRICT_SYNCHRONOUS_TOURNAMENT_COEFFICIENT = 2./3.
SYNCHRONOUS_TOURNAMENT_COEFFICIENT = 0.5
